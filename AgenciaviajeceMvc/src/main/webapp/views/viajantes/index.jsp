...
<body>
	<main>
		...
		<section class="container">
			...
			<div class="p-4">
				<a href="./views/viajantes/create.jsp"
					class="btn btn-primary mb-2 botao1"> Novo Viajante </a>
					...
					<tbody>
						...
						<jstl:forEach items="${listaViajantes}" var="u">
							<tr>
								...
								<td>
									<div class="d-flex">
										<a href="viajante-edit?id=${u.id}" class="mx-1" title="Editar">
											<i class="ri-file-edit-line"></i>
										</a> 
										<a href="viajante-delete?id=${u.id}" class="mx-1" title="Cancelar"
											onclick="return confirm('Deseja excluir o viajante ${u.nome}.')">
